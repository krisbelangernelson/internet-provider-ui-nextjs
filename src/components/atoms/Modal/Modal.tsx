...
export default function Modal(props: ModalProps) {
  ...
  return (
    <>
      <div id="overlay" className={`fixed ${show ? '' : 'hidden'} z-40 w-screen h-screen inset-0 bg-gray-900 bg-opacity-60`} data-testid="overlay"></div>
      ...
      >
        ...
        <div className="flex justify-end">
          <button id="close" className="px-5 py-2 btn-primary text-white cursor-pointer rounded-md" onClick={() => { onHide() }} data-testid="close-button">
            Close
